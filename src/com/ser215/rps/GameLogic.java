 ...
 * Class Description: All the game logic is held in here. This decides if the player can go
...
public class GameLogic {
    ...
    private boolean gameHasStarted;                                 // Holds a boolean to see if a game has started
    ...
    public GameLogic(boolean isSinglePlayer) {
        ...
        if (isSinglePlayer) {
            ...
            this.playerTwo.setPlayerId("CPU");
    ...
    public void playerMadeAThrow(String playerId, int throwType){
        ...
        if (this.playerOneThrow == 9 || this.playerTwoThrow == 9){ // Waiting on someone to throw
            ...
            if (!this.isSinglePlayer)
                ...
                this.gameMessage = "Waiting for computer to throw....";
        }
            ...
            if (this.playerOneThrow == this.playerTwoThrow) {
                ...
                this.gameMessage = "This turn is a tie.";
            }
    ...
    public void removePlayerFromGame(String playerId){
     ...
     // Try to make a throw but test if computer has already made it loop until you get a throw
    public int ComputerMakeAThrow(){
         
        // Variables
        int tmpThrow;
        
        // Loop until we get a good through
        while (true) {
            // Get random int
            Random rand = new Random();
            tmpThrow = rand.nextInt(3);
            if (this.canPlayerMakeThrow(this.playerTwo.getPlayerId(), tmpThrow))
                break;
        }
