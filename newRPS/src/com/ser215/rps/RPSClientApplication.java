...
public class RPSClientApplication extends javax.swing.JFrame {
    ...
    //New
    private static int totalPlayerWins;
    private static int totalPlayerLosts;
    private static int totalPlayerTies;
    
    private static int totalCPUWins;
    private static int totalCPULosts;
    private static int totalCPUTies;
    //New end
    /**
    ...
    private void initComponents() {
        ...
        opponentScissors.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        opponentRock.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        opponentRock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opponentRockActionPerformed(evt);
            }
        });
        ...
        opponentPaper.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        opponentPaper.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                opponentPaperActionPerformed(evt);
            }
        });
        ...
        playerTotalTies.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                playerTotalTiesActionPerformed(evt);
            }
        });
        ...
        oponnentTotalTies.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                oponnentTotalTiesActionPerformed(evt);
            }
        });
    ...
    private void playerRockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playerRockActionPerformed
       makeAThrow(0);
      String tie,win,lose;
     char CPU = ComputerMakeAThrow();
       
       if(CPU == 'R')
       {totalPlayerTies++; 
     tie = Integer.toString(totalPlayerTies);
       playerTotalTies.setText(tie);
       oponnentTotalWins.setText(tie);
     ...
     /*  if(CPU == 'P')
       {totalPlayerLosts++;
       totalCPUWins++;
     player = Integer.toString(totalPlayerWins);
       playerTotalTies.setText(player);
       System.out.println(player);
       }
    ...
    private void opponentRockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opponentRockActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_opponentRockActionPerformed

    private void opponentPaperActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opponentPaperActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_opponentPaperActionPerformed

    private void playerTotalTiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playerTotalTiesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_playerTotalTiesActionPerformed

    private void oponnentTotalTiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_oponnentTotalTiesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_oponnentTotalTiesActionPerformed
